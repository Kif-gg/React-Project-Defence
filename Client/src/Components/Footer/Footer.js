        ...
        <footer>
            <div className="contacts">
                ...
                <ul>
                    ...
                    <li><a href="https://www.facebook.com/azhar.drehi/" target="_blank"><i
            ...
            <div className="developer-contacts">
                ...
                <ul>
                    <li><a href="https://github.com/Kif-gg" target="_blank"><i className="fa-brands fa-github"></i> GitHub</a>
                    </li>
                    <li><a href="mailto:f17.8oy@gmail.com" target="_blank"><i className="fa-solid fa-envelope"></i> Email</a>
                    </li>
                    <li><a href="https://www.facebook.com/kifchoo" target="_blank"><i
